...
public class ControllerAscendente implements KeyListener {
    ...
    public void initView(){
        view_ascendente.jtf_insertar_numero.setText("" +  model_ascendente.getNumero_Insertado());
        view_ascendente.jtf_insertar_numero.addKeyListener(this);
    ...
    public void keyPressed(KeyEvent e){
       if(e.getKeyCode() == 10){
           jbtn_insertar_numeroMouseClicked();
       }
    ...
    public void jbtn_insertar_numeroMouseClicked(){
        model_ascendente.setNumero_Insertado(Double.parseDouble(view_ascendente.jtf_insertar_numero.getText()));
